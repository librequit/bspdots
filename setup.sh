...
noto-color-emoji-fontconfig picom-git exa yt-dlp pipewire pipewire-jack pipewire-alsa pipewire-pulse \
wireplumber ungoogled-dchromium-bin keepassxc mpv nsxiv wget steam lutris catppuccin-gtk-theme-mocha \
vesktop-bin telegram-desktop flameshot pavucontrol 
sleep 3; clear
